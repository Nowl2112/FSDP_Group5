...
public class AppTest {
    ...
    @Test
    public void testBankManagerAddCustomer()
    {
        driver.get("https://www.globalsqa.com/angularJs-protractor/BankingProject/#/login");
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10)); // 10 seconds timeout
        // Wait for the button to be present in the DOM
        WebElement bankManagerLoginButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div/div[2]/div/div[1]/div[2]/button")));
        // Wait for the button to be clickable
        wait.until(ExpectedConditions.elementToBeClickable(bankManagerLoginButton));

        // Click the button
        bankManagerLoginButton.click(); //At Customer Home Page


        WebElement addCustomerButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div/div[2]/div/div[1]/button[1]")));
        wait.until(ExpectedConditions.elementToBeClickable(addCustomerButton));
        addCustomerButton.click(); //At Customer Home Page
